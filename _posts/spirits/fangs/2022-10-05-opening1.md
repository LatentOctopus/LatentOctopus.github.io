...
The idea is to apply the [(G3>G3) -› (G4>G1) growth swap]({% post_url 2022-10-05-concepts.md %}) to reclaim [[Prey on the builders]] often, which helps contain England's heavy building.
